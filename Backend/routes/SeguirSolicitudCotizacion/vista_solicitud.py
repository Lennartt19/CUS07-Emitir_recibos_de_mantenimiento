...
vistasolicitud = Blueprint('vista_solicitud', __name__, url_prefix="/vista_solititud") #al llamar el blue print en base sería (NomreBP.FuncionAsociadaARuta)

@vistasolicitud.route('/vista_solicitud')
...
@vistasolicitud.route('/tipo_predio')
...
@vistasolicitud.route('/solicitante')
...
@vistasolicitud.route('/solicitud')
def vista_solicitud():
...
@vistasolicitud.route('/solicitud_cotizacion')
